    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden min-h-screen flex items-center">
        ...
        <div className="absolute inset-0 w-full h-full">
          <Image src="/bg-factory.jpeg" alt="Factory Pro Background" fill priority className="object-cover" />
        </div>
        ...
        <div className="container relative mx-auto px-4 py-12 sm:py-16 md:py-20 flex items-center min-h-screen">
          <div className="grid grid-cols-1 gap-8 sm:gap-12 items-center w-full">
            <div className="space-y-4 sm:space-y-6 text-center sm:text-right sm:ml-auto max-w-2xl">
              ...
              >
                <span className="text-white font-medium">Factory Pro Platform</span>
              </motion.div>
              <AnimatedText
              ...
              >
                แพลตฟอร์ม <span className="font-bold">Overall Equipment Effectiveness</span>{" "}
        ...
        <div className="container mx-auto px-4 overflow-hidden">
          <AnimatedSection>
            <div className="max-w3xl mx-auto text-center mb-16">
              ...
              >
                แพลตฟอร์ม <span className="font-semibold text-blue-700">OEE</span> หรือ{" "}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <AnimatedSection className="order-2 lg:order-1" delay={0.2} direction="left">
              <div className="space-y-8">
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">เพิ่มประสิทธิภาพการผลิต</h3>
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">ลดความผิดพลาด</h3>
                  <ul className="space-y-3">
                    {["ลดการลงข้อมูลในเอกสารผิดพลาด", "ลดการลงข้อมูลในระบบผิดพลาด", "ลดต้นทุนได้ 10% และเพิ่มผลกำไร 20%"].map(
                      (item, i) => (
                        <motion.li
                          key={i}
                          className="flex items-start"
            ...
            <AnimatedSection className="order-1 lg:order-2" delay={0.4} direction="right">
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection>
            <div className="text-center mb-10">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">ผลลัพธ์ที่คุณจะได้รับ</h2>
              <div className="h-1 w-20 bg-gradient-to-r from-blue-400 to-blue-600 mx-auto mb-6 rounded-full"></div>
            </div>
          </AnimatedSection>
            ...
            <AnimatedSection delay={0.2} direction="left">
              <ul className="space-y-6">
                ...
                >
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-1">Increase OEE</h3>
                    <p className="text-gray-600">เพิ่มค่า OEE ได้อย่างมีประสิทธิภาพด้วยการติดตามและปรับปรุงอย่างต่อเนื่อง</p>
                  </div>
                </motion.li>
              </ul>
            </AnimatedSection>
              ...
              <div className="grid grid-cols-3 gap-4 max-w-4xl mx-auto mt-8">
                ...
                >
                  <AnimatedCounter
                    ...
                    delay={0.2}
                  />
                  <h3 className="text-sm font-bold text-gray-800 mb-1">เพิ่ม OEE</h3>
                  <p className="text-xs text-gray-600">เพิ่มประสิทธิภาพโดยรวมของเครื่องจักร</p>
                </motion.div>
                ...
                >
                  <AnimatedCounter
                    ...
                    delay={0.4}
                  />
                  <h3 className="text-sm font-bold text-gray-800 mb-1">ลดต้นทุน</h3>
                ...
                >
                  <AnimatedCounter
                    ...
                    delay={0.6}
                  />
                  <h3 className="text-sm font-bold text-gray-800 mb-1">เพิ่มกำไร</h3>
                  <p className="text-xs text-gray-600">เพิ่มผลกำไรจากการปรับปรุงประสิทธิภาพ</p>
                </motion.div>
              </div>
            </AnimatedSection>
          </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-blue-300 text-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          >
            <Image src="/bg4Step1.png" alt="Background Pattern 1" fill className="object-contain opacity-8" />
          </motion.div>
          <motion.div
          ...
          >
            <Image src="/bg4Step2.png" alt="Background Pattern 2" fill className="object-contain opacity-8" />
          </motion.div>
        </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-white">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {displayBlogs.slice((blogPage - 1) * itemsPerPage, blogPage * itemsPerPage).map((blog, i) => (
              <AnimatedSection key={blog.id} delay={0.2 + i * 0.2} direction="up">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="bg-white/90 p-6 rounded-xl border border-white/20 mb-8 backdrop-blur-sm">
                  <h3 className="text-xl font-bold text-gray-900 mb-4">ทำไมต้องเลือก Factory Pro?</h3>
                  <ul className="space-y-3">
                    {[
                      "เพิ่ม OEE ได้สูงสุด 15%",
                      "ลดต้นทุนได้ 10%",
      ...
      <footer className="relative text-white">
        {/* Background Image */}
        <div className="absolute inset-0 w-full h-full">
          <Image src="/Foot.png" alt="Footer Background" fill className="object-cover" />
        </div>
          ...
          <div className="container mx-auto px-4 py-8">
            <div className="flex flex-col md:flex-row justify-center items-center gap-8">
              ...
              <div className="text-center md:text-left">
                <h3 className="text-xl font-semibold mb-2">Artron Innovative Co., Ltd.</h3>
                <p className="text-gray-300">37/145 Moo 5, Tiwanon Road, Pakkret Subdistrict,</p>
          ...
          <div className="bg-black py-4">
            <div className="container mx-auto px-4">
              <p className="text-gray-400 text-sm text-center">
                Copyright {new Date().getFullYear()} © All Right Reserved Design by Artron Innovative Co., Ltd.
              </p>
            </div>
          </div>
        </div>
