    ...
    return (
      <Card className="w-full border-0 shadow-xl bg-gradient-to-br from-blue-50 to-cyan-50">
        <CardContent className="p-8 text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-4">ขอบคุณสำหรับการติดต่อ</h3>
          <p className="text-gray-600 mb-6">เราได้รับข้อมูลของคุณเรียบร้อยแล้ว ทีมงานของเราจะติดต่อกลับโดยเร็วที่สุด</p>
  ...
  return (
    <Card className="w-full border-0 shadow-xl bg-gradient-to-br from-blue-50 to-cyan-50">
      <CardHeader className="pb-2">
        <CardTitle className="text-2xl font-bold text-gray-900">ปรึกษาและขอใบเสนอราคา</CardTitle>
        <CardDescription>กรอกข้อมูลของคุณเพื่อรับการติดต่อกลับจากทีมงานของเรา</CardDescription>
      </CardHeader>
      <CardContent>
